...
public class BitYotaSetUpScript : MonoBehaviour
{
	...
	public static void OnPostprocessBuild(BuildTarget target, string pathToBuildProject)
	{
		...
		string objCPath = Application.dataPath + "/Editor/Bityota/SDK";
		Process myCustomProcess = new Process();		
		myCustomProcess.StartInfo.FileName = "python";
        myCustomProcess.StartInfo.Arguments = string.Format("Assets/Editor/BityotaPostProcessor.py \"{0}\" \"{1}\"", pathToBuildProject, objCPath);
